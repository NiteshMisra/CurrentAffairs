...
public class DailyFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rcv = view.findViewById(R.id.daily_rcv);
        rcv.setHasFixedSize(true);
        noInternet = view.findViewById(R.id.dailyNoInternet);
        noData = view.findViewById(R.id.dailyNoData);
        rcv.setLayoutManager(new LinearLayoutManager(this.getActivity()));
        eBookRefresh = view.findViewById(R.id.dailyRefresh);
        loadLayout();
